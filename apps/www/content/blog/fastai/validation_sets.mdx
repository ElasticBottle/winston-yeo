...
publishedAt: 2020-07-10T14:30:26+08:00
slug: "validation-set"
summary: "Difference between training, validation, and test set in machine learning"
...
| Validation Set  | <ul><li>Used to check the fit of our model as it is being tuned.</li><li> Provides an indication of how well our model will generalize </li></ul> | <ul><li> For both supervised and unsupervised tasks, only inputs are provided. </li> <li> Predictions are generated and compared with actual output or category. A score is then calculated based on the grouping</li></ul> |
